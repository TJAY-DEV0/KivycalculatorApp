...
class RoundedInput(FloatLayout):
    def __init__(self,**kwargs):
        ...
        #find image
        image_path = resource_find('assets/images/menu_dots.png')
        
        #Dropmenu
        self.menu = DropDown()
        self.btn_drop_menu = Button(size_hint=(.2,.4),background_normal=image_path,background_down=image_path,pos_hint={'right':0.98,'top':0.95})
...
class RoundedButton(Button):
    ...
    def bind_event(self, event, func):
        ...
        self.bindings.append((event, func))

    def unbind_all(self):
        for event, func in self.bindings:
